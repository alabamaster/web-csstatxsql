							...
							<?php
								...
								foreach ($maps as $r) {
									...
									<tr>
										<td>
											<div class="media">
												<img src="<?=$mapimage;?>" class="mr-3 rounded" style="width: 70px;">
												<div class="media-body">
													<p style="padding-top: 10px;">
														<a style="position: relative;top: 5px" href="#" data-toggle="modal" data-target="#map_id<?=$id;?>"><?=$r['map'];?></a>
													</p>
												</div>
											</div>
										</td>
										<td><span><?=number_format($r['kills']);?></span></td>
										<td><span><?=number_format($r['deaths']);?></span></td>
										<td><span><?=number_format($r['dmg']);?></span></td>
										<td><span><?=$Time->TimeOn($r['connection_time']);?></span></td>
									</tr>
